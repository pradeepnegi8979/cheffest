          ...
          <div className="col-lg-9 col-md-9 col-sm-8">
            ...
            <div className="panel rounded shadow">
              ...
              <div className="panel-footer">
                <button className="btn btn-success pull-right mt-5">
                  POST
                </button>
              ...
              <div className="col-md-6">
                <div className="panel panel-success rounded shadow">
                  <div className="panel-heading no-border">
                    ...
                    <div className="pull-right">
                      <a href="javascript:void(0);" className="text-white h4">
                  ...
                  <div className="panel-body no-padding">
                    ...
                    <div className="inner-all block">
                      view all <a href="javascript:void(0);">7 comments</a>
                    </div>
                    ...
                    <div className="media inner-all no-margin">
                      ...
                      <div className="media-body">
                        <a href="javascript:void(0);" className="h4">
                          John Doe
                        </a>
                    ...
                    <div className="media inner-all no-margin">
                      ...
                      <div className="media-body">
                        ...
                        <small className="block text-muted">
                          Quaerat, impedit minus non commodi facere doloribus
                          nemo ea voluptate nesciunt deleniti.
                        </small>
                        <em className="text-xs text-muted">
                          Posted on{" "}
                          <span className="text-danger">Dec 08, 2014</span>
                ...
                <div className="panel panel-success rounded shadow">
                  ...
                  <div className="panel-body no-padding">
                    <div className="inner-all block">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Expedita, iste omnis fugiat porro consequuntur
                        ratione iure error reprehenderit cum est ab similique
                        magnam molestias aperiam voluptatibus quia aliquid! Sed,
                        minima.
                      </p>
